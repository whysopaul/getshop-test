...
export const ScreenThree = forwardRef(function ScreenThree(_, ref: MutableRefObject<HTMLDivElement>) {
    return <section className='screen-three'>
        <div className='screen-three-background' ref={ref} />
